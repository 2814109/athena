...
func FindAllArticle(ctx context.Context) (models.ArticleSlice, error) {
	...
	articles, modelErr := models.Articles(qm.Load(models.ArticleRels.ArticleStatus)).All(ctx, connectDB)
